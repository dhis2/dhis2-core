...
Get tracked entities updated after given date and time. If no time is specified, 
first millisecond of the day is used.

### `*.parameter.TrackedEntityRequestParams.updatedBefore`

Get tracked entities updated before given date and time. If no time is specified,
...
Get tracked entities with enrollments that were enrolled after given date and time. If no time is specified, 
first millisecond of the day is used.

### `*.parameter.TrackedEntityRequestParams.enrollmentEnrolledBefore`

Get tracked entities with enrollments that were enrolled before given date and time.  If no time is specified,
last millisecond of the day is used.

### `*.parameter.TrackedEntityRequestParams.enrollmentOccurredAfter`

Get tracked entities with enrollments occurred after given date and time. If no time is specified, 
first millisecond of the day is used.

### `*.parameter.TrackedEntityRequestParams.enrollmentOccurredBefore`

Get tracked entities with enrollments occurred before given date and time. If no time is specified,
last millisecond of the day is used.
...
Get tracked entities with an event occurred after given date and time. If no time is specified, 
first millisecond of the day is used.
...
Get tracked entities with an event occurred before given date and time. If no time is specified,
last millisecond of the day is used. 
