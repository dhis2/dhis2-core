...
public class HarConvertedSimulation extends Simulation {
  ...
  private ScenarioBuilder scn = scenario("HarConvertedSimulation")
    .exec(
      http("request_0:POST_http://localhost:8080/api/42/auth/login")
        .post("/api/42/auth/login")
        .headers(headers_0)
        .body(RawFileBody("org/hisp/dhis/test/generated/harconvertedsimulation/0000_request.json")),
      pause(13),
      ...
      http("request_23:POST_http://localhost:8080/api/42/tracker/events/BP72AZQDB5x/note")
        ...
        .headers(headers_0)
        .body(RawFileBody("org/hisp/dhis/test/generated/harconvertedsimulation/0023_request.json")),
      pause(4),
      http("request_24:POST_http://localhost:8080/api/42/tracker/events/BP72AZQDB5x/note")
        .post("/api/42/tracker/events/BP72AZQDB5x/note")
        .headers(headers_0)
        .body(RawFileBody("org/hisp/dhis/test/generated/harconvertedsimulation/0024_request.json")),
      pause(2),
