...
Benchmark reports, charts, and dated evidence are kept as local artifacts outside the
repository; the scripts above regenerate the raw numbers from scratch.
