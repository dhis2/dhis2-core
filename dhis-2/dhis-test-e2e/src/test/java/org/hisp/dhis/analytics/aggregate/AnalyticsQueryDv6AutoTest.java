...
// Given 
    QueryParamsBuilder params = new QueryParamsBuilder().add("filter=ou:ImspTQPwCqd,pe:THIS_YEAR")
        ...
        .add("skipMeta=false")
        .add("dimension=dx:fbfJHSPpUQD;cYeuwXTCPkU;Jtf34kNZhzP,fMZEcRHuamy:qkPbeWaFsnU;wbrDrL2aYEc")
...
// Given 
    QueryParamsBuilder params = new QueryParamsBuilder().add("filter=ou:fdc6uOvgoji")
        .add("skipData=false")
        .add("includeNumDen=false")
        .add("displayProperty=NAME")
        .add("skipMeta=false")
...
// Assert rows.
    validateRow(response,
        List.of("rbkr8PL0rwM", "RXL3lPSK8oG", "2022", "64540", "", "", "", "", ""));
    validateRow(response, List.of("SA7WeFZnUci", "tDZVQ1WtwpA", "2022", "37", "", "", "", "", ""));
    validateRow(response,
        List.of("rbkr8PL0rwM", "uYxK4wmcPqA", "2022", "423046", "", "", "", "", ""));
    validateRow(response, List.of("SA7WeFZnUci", "RXL3lPSK8oG", "2022", "454", "", "", "", "", ""));
    validateRow(response,
        List.of("rbkr8PL0rwM", "tDZVQ1WtwpA", "2022", "46983", "", "", "", "", ""));
    validateRow(response,
        List.of("SA7WeFZnUci", "uYxK4wmcPqA", "2022", "5260", "", "", "", "", ""));
    validateRow(response,
        List.of("ybzlGLjWwnK", "RXL3lPSK8oG", "2022", "3629", "", "", "", "", ""));
    validateRow(response,
        List.of("rbkr8PL0rwM", "EYbopBOJWsW", "2022", "868626", "", "", "", "", ""));
    validateRow(response,
        List.of("V37YqbqpEhV", "CXw2yu5fodb", "2022", "60635", "", "", "", "", ""));
    validateRow(response,
        List.of("SA7WeFZnUci", "EYbopBOJWsW", "2022", "13587", "", "", "", "", ""));
    validateRow(response,
        List.of("V37YqbqpEhV", "uYxK4wmcPqA", "2022", "35724", "", "", "", "", ""));
    validateRow(response,
        List.of("ybzlGLjWwnK", "CXw2yu5fodb", "2022", "36822", "", "", "", "", ""));
    validateRow(response,
        List.of("V37YqbqpEhV", "tDZVQ1WtwpA", "2022", "5654", "", "", "", "", ""));
    validateRow(response,
        List.of("ybzlGLjWwnK", "tDZVQ1WtwpA", "2022", "2095", "", "", "", "", ""));
    validateRow(response,
        List.of("V37YqbqpEhV", "RXL3lPSK8oG", "2022", "6534", "", "", "", "", ""));
    validateRow(response,
        List.of("ybzlGLjWwnK", "EYbopBOJWsW", "2022", "42615", "", "", "", "", ""));
    validateRow(response,
        List.of("ybzlGLjWwnK", "uYxK4wmcPqA", "2022", "17538", "", "", "", "", ""));
    validateRow(response,
        List.of("rbkr8PL0rwM", "CXw2yu5fodb", "2022", "736763", "", "", "", "", ""));
    validateRow(response,
        List.of("V37YqbqpEhV", "EYbopBOJWsW", "2022", "81329", "", "", "", "", ""));
    validateRow(response,
        List.of("SA7WeFZnUci", "CXw2yu5fodb", "2022", "4398", "", "", "", "", ""));
  }
...
// Assert rows.
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "ImspTQPwCqd", "101.5", "252510.0", "248854.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "O6uvpzGd5pu", "142.3", "33398.0", "23475.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "fdc6uOvgoji", "82.2", "17031.0", "20721.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "lc3eMKXaEfw", "90.0", "6703.0", "7448.0", "100.0", "36500",
            "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "jUb8gELQApl", "81.6", "15145.0", "18565.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "PMa2VCrupOd", "102.9", "14320.0", "13921.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "kJq2mPyFEHo", "94.4", "24347.0", "25785.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "qhqAxPSTUXp", "67.0", "9084.0", "13568.0", "100.0", "36500",
            "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "Vth0fbpFcsO", "52.8", "9254.0", "17540.0", "100.0", "36500",
            "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "jmIPBj66vD6", "118.4", "16169.0", "13655.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "TEQlaapDQoK", "99.5", "23773.0", "23892.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "bL4ooGhyHRQ", "88.5", "10662.0", "12041.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "eIQbndfxQMb", "124.7", "22505.0", "18048.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "2022", "at6UHUQatSo", "124.7", "50119.0", "40195.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "ImspTQPwCqd", "65.8", "163818.0", "248854.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "O6uvpzGd5pu", "92.3", "21679.0", "23475.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "fdc6uOvgoji", "51.0", "10558.0", "20721.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "lc3eMKXaEfw", "59.7", "4449.0", "7448.0", "100.0", "36500",
            "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "jUb8gELQApl", "71.0", "13175.0", "18565.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "PMa2VCrupOd", "65.2", "9074.0", "13921.0", "100.0", "36500",
            "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "kJq2mPyFEHo", "86.8", "22378.0", "25785.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "qhqAxPSTUXp", "38.8", "5259.0", "13568.0", "100.0", "36500",
            "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "Vth0fbpFcsO", "36.9", "6478.0", "17540.0", "100.0", "36500",
            "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "jmIPBj66vD6", "92.4", "12620.0", "13655.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "TEQlaapDQoK", "47.8", "11422.0", "23892.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "bL4ooGhyHRQ", "56.9", "6856.0", "12041.0", "100.0", "36500",
            "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "eIQbndfxQMb", "58.7", "10589.0", "18048.0", "100.0",
            "36500", "365"));
    validateRow(response,
        List.of("sB79w2hiLp8", "2022", "at6UHUQatSo", "72.8", "29281.0", "40195.0", "100.0",
            "36500", "365"));
  }
...
// Given 
    QueryParamsBuilder params = new QueryParamsBuilder().add("skipData=false")
        ...
        .add("displayProperty=NAME")
        .add("skipMeta=false")
        .add("dimension=dx:Uvn6LCg7dVU;OdiHJayrsKo;sB79w2hiLp8,ou:ImspTQPwCqd,pe:LAST_4_QUARTERS")
        .add("relativePeriodDate=2022-01-01");
...
// Assert rows.
    validateRow(response,
        List.of("Uvn6LCg7dVU", "ImspTQPwCqd", "2021Q1", "100.9", "60689.0", "243951.0", "405.6",
            "36500", "90"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "ImspTQPwCqd", "2021Q2", "118.1", "71850.0", "243951.0", "401.1",
            "36500", "91"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "ImspTQPwCqd", "2021Q3", "108.4", "66668.0", "243951.0", "396.7",
            "36500", "92"));
    validateRow(response,
        List.of("Uvn6LCg7dVU", "ImspTQPwCqd", "2021Q4", "87.9", "54062.0", "243951.0", "396.7",
            "36500", "92"));
    validateRow(response,
        List.of("OdiHJayrsKo", "ImspTQPwCqd", "2021Q1", "92.0", "55331.0", "243951.0", "405.6",
            "36500", "90"));
    validateRow(response,
        List.of("OdiHJayrsKo", "ImspTQPwCqd", "2021Q2", "108.6", "66033.0", "243951.0", "401.1",
            "36500", "91"));
    validateRow(response,
        List.of("OdiHJayrsKo", "ImspTQPwCqd", "2021Q3", "100.8", "61976.0", "243951.0", "396.7",
            "36500", "92"));
    validateRow(response,
        List.of("OdiHJayrsKo", "ImspTQPwCqd", "2021Q4", "82.5", "50749.0", "243951.0", "396.7",
            "36500", "92"));
    validateRow(response,
        List.of("sB79w2hiLp8", "ImspTQPwCqd", "2021Q1", "62.9", "37816.0", "243951.0", "405.6",
            "36500", "90"));
    validateRow(response,
        List.of("sB79w2hiLp8", "ImspTQPwCqd", "2021Q2", "72.1", "43854.0", "243951.0", "401.1",
            "36500", "91"));
    validateRow(response,
        List.of("sB79w2hiLp8", "ImspTQPwCqd", "2021Q3", "72.9", "44820.0", "243951.0", "396.7",
            "36500", "92"));
    validateRow(response,
        List.of("sB79w2hiLp8", "ImspTQPwCqd", "2021Q4", "60.7", "37336.0", "243951.0", "396.7",
            "36500", "92"));
  }
}