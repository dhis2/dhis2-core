...
// Given 
    QueryParamsBuilder params = new QueryParamsBuilder().add("filter=ou:ImspTQPwCqd,dx:Uvn6LCg7dVU")
        .add("skipData=false")
        .add("displayProperty=NAME")
        .add("skipMeta=false")
...
// Assert rows.
    validateRow(response,
        List.of("fbfJHSPpUQD", "202107", "ImspTQPwCqd", "22356", "", "", "", "", ""));
    validateRow(response,
        List.of("fbfJHSPpUQD", "202106", "ImspTQPwCqd", "23813", "", "", "", "", ""));
    validateRow(response,
        List.of("fbfJHSPpUQD", "202109", "ImspTQPwCqd", "22308", "", "", "", "", ""));
    validateRow(response,
        List.of("fbfJHSPpUQD", "202104", "ImspTQPwCqd", "18576", "", "", "", "", ""));
    validateRow(response,
        List.of("fbfJHSPpUQD", "202108", "ImspTQPwCqd", "22004", "", "", "", "", ""));
    validateRow(response,
        List.of("fbfJHSPpUQD", "202105", "ImspTQPwCqd", "29461", "", "", "", "", ""));
    validateRow(response,
        List.of("fbfJHSPpUQD", "202110", "ImspTQPwCqd", "17926", "", "", "", "", ""));
    validateRow(response,
        List.of("fbfJHSPpUQD", "202112", "ImspTQPwCqd", "16445", "", "", "", "", ""));
    validateRow(response,
        List.of("fbfJHSPpUQD", "202111", "ImspTQPwCqd", "19691", "", "", "", "", ""));
    validateRow(response,
        List.of("fbfJHSPpUQD", "202101", "ImspTQPwCqd", "20026", "", "", "", "", ""));
    validateRow(response,
        List.of("fbfJHSPpUQD", "202103", "ImspTQPwCqd", "21877", "", "", "", "", ""));
    validateRow(response,
        List.of("fbfJHSPpUQD", "202102", "ImspTQPwCqd", "18786", "", "", "", "", ""));
  }

  @Test
  public void queryAnc1stVisitsLast12MonthsCumulativeValues() throws JSONException {
// Given 
    QueryParamsBuilder params = new QueryParamsBuilder().add("filter=dx:fbfJHSPpUQD")
        .add("skipData=false")
        .add("includeNumDen=false")
        .add("displayProperty=NAME")
        .add("skipMeta=false")
...
// Assert metaData. 
    String expectedMetaData = "{\"items\":{\"dx\":{\"name\":\"Data\"},\"pe\":{\"name\":\"Period\"},\"OdiHJayrsKo\":{\"name\":\"ANC 2 Coverage\"},\"THIS_YEAR\":{\"name\":\"This year\"},\"2022\":{\"name\":\"2022\"}},\"dimensions\":{\"dx\":[\"OdiHJayrsKo\"],\"pe\":[\"2022\"],\"co\":[]}}";
    String actualMetaData = new JSONObject((Map) response.extract("metaData")).toString();
    assertEquals(expectedMetaData, actualMetaData, false);
