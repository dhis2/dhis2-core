...
// Assert metaData. 
String expectedMetaData = "{\"count\":5,\"orderBy\":\"z_score\",\"threshold\":\"3.0\",\"maxResults\":30,\"algorithm\":\"Z_SCORE\"}";String actualMetaData = new JSONObject((Map)response.extract("metaData")).toString();
...
validateRow(response,2, List.of("x3Do5e7g4Qo","OPV0 doses given","202207","July 2022","DiszpKrYNg8","Ngelehun CHC","/Sierra Leone/Bo/Badjia/Ngelehun CHC","hEFKSsPV5et","Outreach, >1y","HllvX50cXC0","default","245.0","43.01818","64.62015","201.98182","3.12568","-150.84226","236.87862"));
validateRow(response,3, List.of("pnL2VG8Bn7N","Weight for height 70-79 percent","202207","July 2022","mzsOsz0NwNY","New Police Barracks CHC","/Sierra Leone/Bo/Kakua/New Police Barracks CHC","Prlt0C1RF0s","Fixed, <1y","HllvX50cXC0","default","120.0","28.96124","28.86816","91.03876","3.1536","-57.64324","115.56572"));
...
// Assert metaData. 
String expectedMetaData = "{\"count\":0,\"orderBy\":\"z_score\",\"threshold\":\"5.0\",\"maxResults\":30,\"algorithm\":\"Z_SCORE\"}";String actualMetaData = new JSONObject((Map)response.extract("metaData")).toString();
assertEquals(expectedMetaData, actualMetaData, false);
...
// Assert metaData. 
String expectedMetaData = "{\"count\":0,\"orderBy\":\"z_score\",\"threshold\":\"10.0\",\"maxResults\":30,\"algorithm\":\"MOD_Z_SCORE\"}";String actualMetaData = new JSONObject((Map)response.extract("metaData")).toString();
assertEquals(expectedMetaData, actualMetaData, false);
