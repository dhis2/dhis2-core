...
// Given 
    QueryParamsBuilder params = new QueryParamsBuilder().add("filter=pe:THIS_YEAR,dx:hfdmMSPBgLG")
        .add("skipData=false")
        .add("includeNumDen=false")
        .add("displayProperty=NAME")
        .add("skipMeta=false")
...
// Given 
    QueryParamsBuilder params = new QueryParamsBuilder().add(
            "filter=pe:THIS_YEAR,dx:hfdmMSPBgLG,ou:USER_ORGUNIT")
        .add("skipData=false")
        .add("includeNumDen=false")
        .add("displayProperty=NAME")
        .add("skipMeta=false")
