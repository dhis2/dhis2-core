...
@Test
 public void queryAggregatedenrollmentsbirthgenderthisyearlast12monthslevel2twice() throws JSONException {
// Given 
QueryParamsBuilder params = new QueryParamsBuilder().add("stage=A03MvHHogjR")
.add("displayProperty=SHORTNAME")
.add("totalPages=false")
.add("outputType=ENROLLMENT")
.add("dimension=ou:kJq2mPyFEHo;O6uvpzGd5pu,pe:THIS_YEAR;LAST_12_MONTHS,A03MvHHogjR.cejWyOfXge6")
;
...
validateRow(response, List.of("2","O6uvpzGd5pu","2022",""));
 ...
 public void queryAggregatedenrollmentsbirthbcgdosegenderthismonthlastmonthlevel4org() throws JSONException {
// Given 
QueryParamsBuilder params = new QueryParamsBuilder().add("stage=A03MvHHogjR")
.add("displayProperty=SHORTNAME")
.add("totalPages=false")
.add("outputType=ENROLLMENT")
.add("dimension=ou:DiszpKrYNg8,pe:THIS_MONTH;LAST_MONTH,A03MvHHogjR.bx6fsa0t90x,A03MvHHogjR.cejWyOfXge6")
;
...
// Assert rows.
 ...
 public void queryAggregatedenrollmentsbirthbcgdosegenderthisyearlastyearlevel4org() throws JSONException {
// Given 
QueryParamsBuilder params = new QueryParamsBuilder().add("stage=A03MvHHogjR")
.add("displayProperty=SHORTNAME")
.add("totalPages=false")
.add("outputType=ENROLLMENT")
.add("dimension=ou:DiszpKrYNg8,pe:THIS_YEAR;LAST_YEAR,A03MvHHogjR.bx6fsa0t90x,A03MvHHogjR.cejWyOfXge6")
;
...
// Assert metaData. 
String expectedMetaData = "{\"pager\":{\"page\":1,\"pageSize\":50,\"isLastPage\":true},\"items\":{\"DiszpKrYNg8\":{\"name\":\"Ngelehun CHC\"},\"Mnp3oXrpAbK\":{\"code\":\"Female\",\"name\":\"Female\"},\"rBvjJYbMCVx\":{\"code\":\"Male\",\"name\":\"Male\"},\"bx6fsa0t90x\":{\"name\":\"MCH BCG dose\"},\"pe\":{},\"IpHINAT79UW\":{\"name\":\"Child Programme\"},\"ZzYYXq4fJie\":{\"name\":\"Baby Postnatal\"},\"ou\":{\"name\":\"Organisation unit\"},\"A03MvHHogjR\":{\"name\":\"Birth\"},\"2023\":{\"name\":\"2023\"},\"2022\":{\"name\":\"2022\"},\"cejWyOfXge6\":{\"name\":\"Gender\"}},\"dimensions\":{\"pe\":[\"2022\",\"2023\"],\"ou\":[\"DiszpKrYNg8\"],\"A03MvHHogjR.bx6fsa0t90x\":[],\"cejWyOfXge6\":[\"rBvjJYbMCVx\",\"Mnp3oXrpAbK\"]}}";String actualMetaData = new JSONObject((Map)response.extract("metaData")).toString();
assertEquals(expectedMetaData, actualMetaData, false);
...
validateRow(response, List.of("1","DiszpKrYNg8","2023","Male",""));
 ...
 public void queryAggregatedenrollmentsbirthgenderthisyearlevel4orgwithheaders() throws JSONException {
// Given 
QueryParamsBuilder params = new QueryParamsBuilder().add("headers=pe,A03MvHHogjR.cejWyOfXge6,value")
...
validateHeader(response,1,"A03MvHHogjR.cejWyOfXge6","Gender","TEXT","java.lang.String",false,true);
