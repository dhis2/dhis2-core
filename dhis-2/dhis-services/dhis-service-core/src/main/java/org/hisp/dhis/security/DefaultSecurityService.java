    ...
    implements SecurityService
{
    ...
    private Cache userFailedLoginAttemptCache;
    ...
    public void init()
    {
        this.userFailedLoginAttemptCache = cacheProvider.createCacheInstance( "userFailedLoginAttempt", false, LOGIN_LOCKOUT_MINS*SECONDS_PER_MIN,  -1 , 0 );
