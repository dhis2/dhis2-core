...
#
# ./generate-antlr-files.sh /usr/local/lib/antlr-4.7.2-complete.jar

java -jar $1 -o ../../../../../java/org/hisp/dhis/expressionparser/generated/ -no-listener -visitor -package org.hisp.dhis.expressionparser.generated Expression.g4
