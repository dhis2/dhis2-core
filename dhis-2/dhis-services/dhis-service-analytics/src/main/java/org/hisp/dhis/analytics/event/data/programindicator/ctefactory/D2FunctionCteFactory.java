...
public class D2FunctionCteFactory implements CteSqlFactory {
    ...
    public String process(String rawSql,
        ...
        while (matcher.find()) {
            ...
            Optional<PlaceholderParser.D2FuncFields> opt = PlaceholderParser.parseD2Func(matcher.group(0));
            ...
            ensureCte(cteKey, p, programIndicator,
                    earliestStart, latestEnd, cteContext, sqlBuilder);
    ...
    private String buildKey(PlaceholderParser.D2FuncFields p) {
        return String.format("d2%s_%s_%s_%s_%s_%s",
                p.func().toLowerCase(),
                p.psUid(),
                p.deUid(),
    ...
    private void ensureCte(String key,
