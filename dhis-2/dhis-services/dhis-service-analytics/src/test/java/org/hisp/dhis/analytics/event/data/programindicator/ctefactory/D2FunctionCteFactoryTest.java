...
class D2FunctionCteFactoryTest extends TestBase {
    ...
    class HappyPath {
        ...
        @Test
        void countIfValue() {
            String ph = "__D2FUNC__(func='countIfValue', ps='PS1', de='DE1', " +
                    "argType='val64', arg64='" + b64("42") + "', hash='h', pi='" + pi.getUid() + "')__";
        ...
        void countIfCondition() {
            String cond = "'< 10'";
            String ph = "__D2FUNC__(func='countIfCondition', ps='PS1', de='DE1', " +
                    "argType='condLit64', arg64='" + b64(cond) + "', hash='h', pi='" + pi.getUid() + "')__";
            String sql = "where " + ph;
        ...
        @Test
        void count() {
            String ph = "__D2FUNC__(func='count', ps='PS1', de='DE1', " +
                    "argType='none', arg64='', hash='h', pi='" + pi.getUid() + "')__";
            String sql = "select " + ph;
    ...
    class ErrorCases {
        ...
        void malformedBase64_isIgnored() {
            String ph = "__D2FUNC__(func='countIfValue', ps='PS', de='DE', " +
                    "argType='val64', arg64='**BAD**', hash='h', pi='" + pi.getUid() + "')__";
            String sql = "select " + ph;
        ...
        void unsupportedFunction_isIgnored() {
            String ph = "__D2FUNC__(func='sum', ps='PS', de='DE', " +
                    "argType='none', arg64='', hash='h', pi='" + pi.getUid() + "')__";
            String sql = "select " + ph;
    ...
    void regexFindsPlaceholders() {
        String ph1 = "__D2FUNC__(func='count', ps='P', de='D', argType='none', arg64='', hash='h', pi='X')__";
        String ph2 = "__D2FUNC__(func='count', ps='P', de='D', argType='none', arg64='', hash='h', pi='X')__";
        String sql = ph1 + " + " + ph2;
    ...
    void emptyArg64_stillGeneratesCte() {
        String ph = "__D2FUNC__(func='countIfValue', ps='PS', de='DE', " +
                "argType='val64', arg64='', hash='h', pi='" + pi.getUid() + "')__";
    ...
    void conditionWithStringLiteral_generatesSql() {
        String arg = "'>= \"ABC\"'";
        String ph = "__D2FUNC__(func='countIfCondition', ps='PS', de='DE', " +
                "argType='condLit64', arg64='" + b64(arg) + "', hash='h', pi='" + pi.getUid() + "')__";
    ...
    void unparsableCondition_isIgnored() {
        ...
        String ph  = "__D2FUNC__(func='countIfCondition', ps='P', de='D', " +
                "argType='condLit64', arg64='"+b64(arg)+"', hash='h', pi='"+pi.getUid()+"')__";
    ...
    void badBase64_skipsPlaceholder() {
        String ph = "__D2FUNC__(func='countIfValue', ps='P', de='D', " +
                "argType='val64', arg64='@@@', hash='h', pi='"+pi.getUid()+"')__";
        String in = "select "+ph;
    ...
    void duplicatePlaceholder_createsOneCte() {
        String ph = "__D2FUNC__(func='count', ps='P', de='D', argType='none', arg64='', hash='h', pi='"+pi.getUid()+"')__";
        String sql = ph + " + " + ph;
    ...
    void piWithoutProgram_leavesPlaceholder() {
        ...
        String ph = "__D2FUNC__(func='count', ps='P', de='D', argType='none', arg64='', hash='h', pi='X')__";
        String sql = "select "+ph;
    ...
    void existingCteAlias_isReused() {
        ...
        // pre-seed context
        String key = "d2count_P_D_noarg_h_" + pi.getUid();
        CteDefinition seeded = CteDefinition.forD2Function(key, "dummy_sql", "enrollment");
        String seededAlias = seeded.getAlias();          // capture auto-generated alias
        ctx.addD2FunctionCte(key, seeded);

        String out = factory.process("select " + placeholder, pi, from, to, ctx, alias, qb);

        assertTrue(out.contains(seededAlias + ".value"));  // factory reused existing alias
        assertEquals(1, ctx.getCteKeys().size());          // no duplicate CTE added
        assertEquals(seededAlias, alias.get(placeholder)); // aliasMap points to same alias
    }

    @Test
    void count_withIgnoredArg64_stillWorks() {
        String ph = "__D2FUNC__(func='count', ps='P', de='D', argType='none', arg64='XYZ', hash='h', pi='"+pi.getUid()+"')__";
        String out = factory.process("select "+ph, pi, from, to, ctx, alias, qb);
    ...
    void mixedPlaceholders_bothHandled() {
        String p1 = "__D2FUNC__(func='count', ps='P', de='D', argType='none', arg64='', hash='h1', pi='"+pi.getUid()+"')__";
        String p2 = "__D2FUNC__(func='countIfValue', ps='P', de='D', argType='val64', arg64='"+b64("1")+"', hash='h2', pi='"+pi.getUid()+"')__";
        String sql = p1 + " || " + p2;
