...
alter table datadimensionitem add column if not exists programdataelementoption_aggregation varchar(50);
...
alter table datadimensionitem add column if not exists programattributeoption_aggregation varchar(50);
