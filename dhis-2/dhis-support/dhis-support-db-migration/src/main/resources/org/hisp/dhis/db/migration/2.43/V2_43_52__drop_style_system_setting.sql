...
-- The keyStyle setting was only used in mobile and is superseded by the new keyUiCustomColorMobile setting
insert into systemsetting(systemsettingid, name, value)
select nextval('hibernate_sequence'), 'keyUiCustomColorMobile', mappings.new_value
from (values
