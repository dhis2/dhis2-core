...
mvn clean install --batch-mode --no-transfer-progress --threads 2C -DskipTests -f "$DIR"/pom.xml -pl -dhis-web-embedded-jetty
mvn clean install --batch-mode --no-transfer-progress --threads 2C -DskipTests -f "$DIR"/dhis-web/pom.xml
